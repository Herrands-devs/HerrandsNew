...
const InProgressBoard = ({navigation , route}) => {
   ...
   switch(status) {
      ...
      case 'COMPLETED' :
         ...
         modalText = 'By tapping proceed it means your task has been completed successfully'
         break;
      default : 
         ...
         <View className="p-6 flex gap-8">
            ...
            <View className="flex gap-2">
               <View className="flex justify-between flex-row">
                  ...
                  <Text className="text-[18px] font-montserratRegular text-[#000E23]">{data.estimated_pick_up_time}</Text>
               </View>
               <View className="flex flex-row items-center">
            ...
            <View className="flex gap-2">
               <View className="flex justify-between flex-row">
                  ...
                  <Text className="text-[18px] font-montserratRegular text-[#000E23]">{data.estimated_drop_off_time}</Text>
               </View>
               <View className="flex flex-row items-center">
                  <Image source={require('../../../../assets/icons/email.png')} />
                  <Text className="text-[#000E23] font-montserratRegular ml-2">{data.pick_up_address}.</Text>
            ...
            <View className="flex gap-2">
               ...
               <View className="flex flex-row items-center justify-between">
                  <View className="flex flex-row items-center">
                     ...
                     <Text className="text-[#000E23] font-montserratRegular ml-2">{updateText}</Text>
                  </View>
                  {status !== 'COMPLETED'&&
                  <TouchableOpacity 
