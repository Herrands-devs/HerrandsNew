   ...
   return (
      <SafeAreaView className="bg-white h-full">
         <View  className="p-6 font-montserratRegular flex flex-row items-center gap-5">
            ...
            <Text className="text-[24px] text-[#000E23] font-semibold font-MontserratMedium">Profile</Text>
         </View>
         ...
         <View style={styles.container}>
            <View className="relative w-[118px] h-[118px]">
               ...
               />
               <View className="bg-[#1FF30C] border-4 border-white w-[20px] h-[20px] rounded-full" style={styles.badge}>
                  <View />
               </View>
            </View>
            <View>
               <Text className="text-center text-[#000E23] font-semibold text-[16px]">Kunle Afolayan</Text>
            </View>
            <View className="flex flex-row justify-center w-full text-center">
               <View className="w-[50%] flex flex-row justify-end pr-2">
                  <Text className="text-end text-[#000E23] font-medium">12 Errands</Text>
               </View>
               <View className="flex flex-row w-[50%] pl-2 border-l border-[#000E23 justify-start">
                  <Text className="mr-2 text-[#000E23] font-medium">Ranting : 4.5</Text>
                  <Image source={require("../../../assets/icons/rate-icon.png")} className="w-[15px] h-[15px]" />
               </View>
            </View>
            ...
            <View className="border-t w-[90%] flex flex-col  py-4 border-[#F9F9F9]">
               <View className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     ...
                     <Text className="text-[18px] font-montserratRegular">Language</Text>
                  </View>
               ...
               <View className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     ...
                     <Text className="text-[18px] font-montserratRegular">Out of office</Text>
                  </View>
               ...
               <View className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     <Image source={webIcon} />
                     <Text className="text-[18px] font-montserratRegular">Notifications</Text>
                  </View>
                  <View style={styles.view}>
                     <Switch
                        value={checked}
               ...
               <TouchableOpacity onPress={() => navigation.navigate('Support')} className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     <Image source={supportIcon} />
                     <Text className="text-[18px] font-montserratRegular">Support</Text>
                  </View>
               ...
               <View className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     ...
                     <Text className="text-[18px] font-montserratRegular">Log out</Text>
                  </View>
               </View>
               ...
               <View className="flex flex-row justify-between pb-12 items-center w-full">
                  <View className="flex flex-row gap-8 items-center">
                     ...
                     <Text className="text-[18px] text-[#6B7C97] font-montserratRegular">Delete Account</Text>
                  </View>
               </View>
            </View>
         </View>
