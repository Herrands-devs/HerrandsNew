...
import { DisabledRoundedBtn, DisabledSquareBtn, SquareButton } from '../../../components/common/Button'
      ...
      <SafeAreaView>
         ...
         <View className="p-6 w-full">
            ...
            <View className="flex w-full items-center  h-[150px] justify-between">
               ...
               phone_number === undefined || phone_number === "" || phone_number.toString().length < 10 ? (
