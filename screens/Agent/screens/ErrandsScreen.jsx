    ...
    <ScrollView className="flex gap-[1px]">
      ...
      >
        ...
        <View className="flex flex-col gap-2">
          ...
          <Text className="text-[#C6C6C6] text-[14px] font-montserratRegular">Duration : 45min </Text>
        </View>
  ...
  return (
    <ScrollView className="flex gap-[1px]">
      ...
      >
        ...
        <View className="flex flex-col gap-2">
          <Text className="text-[#000E23] text-[20px]">Send a Package</Text>
          <Text className="text-[#C6C6C6] text-[14px] font-montserratRegular">Herrand Completed</Text>
        </View>
